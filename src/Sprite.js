...
export class Sprite extends GameObject {
  constructor({
    resource, // imagem que queremos desenhar
    frameSize, // tamanho do recorte da imagem
    hFrames, // disposição horizontal
    vFrames, // disposição vertical
    frame, // qual frame vamos mostrar
    scale, 
    position,
    animations
  }) {
